...
def write(voxel_model, fp):
    ...
    fp.write(b'#binvox 1\n')
    fp.write(b'dim '+b' '.join(map(lambda x: str(x).encode('ascii'), voxel_model.dims))+b'\n')
    fp.write(b'translate '+b' '.join(map(lambda x: str(x).encode('ascii'), voxel_model.translate))+b'\n')
